...
__all__ = [
    'SREAudioLevel', 'DISPID_SPRuleParent', 'DISPID_SABIBufferSize',
    'DISPID_SVRate', 'DISPID_SRRAlternates', 'SPGS_ENABLED',
    'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpSerializeState', 'SAFT44kHz16BitMono', 'SAFT48kHz8BitMono',
    'SRAInterpreter', 'DISPID_SOTDisplayUI', 'SPEI_SOUND_END',
    'ISpeechWaveFormatEx', 'DISPID_SOTDataKey', 'SpPhoneConverter',
    'SLODynamic', 'SpeechPropertyResourceUsage', 'ISpRecognizer3',
    'SDA_No_Trailing_Space', 'SDTAlternates', 'SPPS_RESERVED3',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRGSetTextSelection',
    'DISPID_SOTId', 'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SLWWord',
    'DISPID_SGRSTPropertyValue', 'SAFT16kHz16BitMono',
    'SAFT32kHz16BitStereo', 'SDTReplacement', 'SPBO_NONE',
    'SpeechCategoryAudioOut', 'DISPID_SRRTOffsetFromStart',
    'SRTReSent', 'SAFT11kHz8BitMono', 'ISpRecognizer',
    'DISPID_SGRsCommitAndSave', 'SAFTADPCM_44kHzMono',
    'DISPID_SpeechGrammarRules', 'ISpeechRecoResultTimes',
    'DISPID_SASState', 'DISPIDSPTSI_ActiveOffset', 'DISPID_SOTsCount',
    'DISPID_SRGDictationLoad', 'DISPID_SWFEChannels',
    'SPINTERFERENCE', 'eLEXTYPE_PRIVATE8', 'DISPID_SRSAudioStatus',
    'DISPID_SRGetPropertyNumber', 'DISPID_SDKGetStringValue',
    'STCInprocServer', 'DISPID_SBSFormat', 'SVP_6',
    'DISPID_SVGetVoices', 'DISPID_SOTs_NewEnum',
    'SVESentenceBoundary', 'ISpStream', 'SAFT12kHz16BitStereo',
    'DISPID_SMSADeviceId', 'DISPID_SGRSTPropertyId', 'SFTSREngine',
    'DISPID_SVSVisemeId', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPVPRI_ALERT', 'SPBO_AHEAD', 'DISPID_SLWLangId', 'SVP_2',
    'DISPID_SVResume', 'SPWF_SRENGINE', 'DISPID_SVSRunningState',
    'SPPS_Unknown', 'DISPID_SOTCGetDataKey', 'SpWaveFormatEx',
    'SAFTDefault', 'ISpeechVoice', '_ISpeechRecoContextEvents',
    'SPWF_INPUT', 'SVP_9', 'DISPID_SPIGetDisplayAttributes',
    'SITooLoud', 'DISPID_SRCRecognizer', 'SPRECOSTATE',
    'SAFTNoAssignedFormat', 'DISPID_SGRSTType',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPEsItem',
    'DISPID_SRCERecognition', 'SAFT8kHz16BitStereo',
    'SREInterference', 'SRARoot', 'SpCompressedLexicon',
    'DISPID_SPPParent', 'SpMMAudioOut', 'SWPUnknownWordPronounceable',
    'DISPID_SVGetProfiles', 'DISPID_SRCEFalseRecognition',
    'DISPID_SGRsCount', 'SpeechLoadOption', 'ISpeechLexicon',
    'SpeechAudioFormatGUIDText', 'eWORDTYPE_DELETED',
    'SpeechDisplayAttributes', 'SpeechRetainedAudioOptions',
    'DISPID_SPRuleEngineConfidence', 'ISpeechPhraseElement',
    'SPPS_Interjection', 'DISPIDSPTSI_SelectionOffset',
    'SAFTADPCM_11kHzMono', 'DISPID_SASCurrentSeekPosition',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRIsShared', 'DISPID_SOTsItem',
    'SPRULESTATE', 'DISPID_SRCreateRecoContext', 'SPEI_SR_BOOKMARK',
    'SVSFIsFilename', 'ISpPhoneticAlphabetConverter', 'SpAudioFormat',
    'eLEXTYPE_USER', 'DISPID_SRCERequestUI',
    'DISPID_SPPNumberOfElements', 'SECFDefault', 'SpNotifyTranslator',
    'DISPID_SRCEPropertyStringChange', 'SpeechPropertyAdaptationOn',
    'SPPS_NotOverriden', 'DISPID_SRGCommit',
    'DISPID_SpeechPhraseReplacements', 'SPPS_Verb',
    'SPPS_SuppressWord', 'SRESoundStart', 'DISPID_SRCCreateGrammar',
    'SGLexical', 'SPFILEMODE', 'SPEI_START_INPUT_STREAM',
    'SP_VISEME_11', 'SAFT11kHz16BitMono', 'DISPID_SOTCDefault',
    'SpeechAudioVolume', 'ISpeechObjectTokenCategory',
    'SpeechGrammarTagUnlimitedDictation', 'ISpeechLexiconWords',
    'SPEI_SOUND_START', 'DISPID_SPAStartElementInResult',
    'SpeechVoiceSkipTypeSentence', 'SPLO_STATIC', 'eLEXTYPE_PRIVATE7',
    'DISPIDSPRG', 'DISPID_SRRRecoContext',
    'DISPID_SVESentenceBoundary', 'eLEXTYPE_PRIVATE5',
    'DISPID_SGRsAdd', 'DISPID_SLWs_NewEnum', 'SPCT_COMMAND',
    'ISpeechPhraseElements', 'SRTEmulated', 'DISPID_SGRSTs_NewEnum',
    'SVSFPersistXML', 'DISPID_SDKEnumKeys', 'SDTAudio',
    'SpTextSelectionInformation', 'SINoise', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SpeechObjectTokenCategory', 'SVPAlert',
    'SpInProcRecoContext', 'SAFTGSM610_11kHzMono', 'SREStreamStart',
    'ISpEventSource', 'DISPID_SRSetPropertyNumber', 'SVPNormal',
    'SpeechTokenKeyUI', 'ISpeechRecoResultDispatch', 'SPLOADOPTIONS',
    'DISPID_SPILanguageId', 'ISequentialStream', 'DISPID_SGRSTsCount',
    'SAFT24kHz8BitMono', 'SPEI_MAX_TTS', 'SAFT22kHz16BitMono',
    'SPXRO_SML', 'DISPID_SVEStreamStart', 'DISPID_SPEs_NewEnum',
    'SRAORetainAudio', 'DISPID_SPRDisplayAttributes',
    'SREPropertyNumChange', 'SVP_21', 'DISPID_SWFEAvgBytesPerSec',
    'SAFT24kHz16BitMono', 'SAFTCCITT_uLaw_8kHzStereo', 'SP_VISEME_16',
    'eLEXTYPE_PRIVATE11', 'eLEXTYPE_PRIVATE4', 'DISPID_SWFEFormatTag',
    ...
    'DISPID_SOTCreateInstance', 'SpeechDiscardType', 'SpCustomStream',
    'ISpVoice', 'SPSSuppressWord', 'SPCATEGORYTYPE',
    'DISPID_SGRSAddRuleTransition', 'ISpRecoContext',
    'DISPID_SVEPhoneme', 'DISPID_SPPFirstElement', 'SPPS_Function',
    'SAFT16kHz8BitMono', 'SPEI_UNDEFINED', 'DISPID_SpeechVoiceStatus',
    'ISpObjectWithToken', 'ISpNotifySink', 'SPPHRASE',
    'SPDKL_LocalMachine', 'SRERecognition', 'SWTAdded',
    'DISPID_SVAlertBoundary', 'DISPID_SPAPhraseInfo', 'SP_VISEME_4',
    'DISPID_SRGRules', 'DISPID_SRCEInterference',
    'SpeechAudioFormatGUIDWave', 'SP_VISEME_15',
    'SpeechGrammarTagWildcard', 'SPEI_HYPOTHESIS', 'SPEI_RESERVED6',
    'DISPID_SGRsDynamic', 'DISPIDSPTSI_ActiveLength', 'SP_VISEME_10',
    'SAFT16kHz16BitStereo', 'SPAR_High',
    'DISPID_SpeechPhoneConverter', 'SPSERIALIZEDPHRASE',
    'ISpeechVoiceStatus', 'SVEStartInputStream',
    'DISPID_SDKGetBinaryValue', 'SpeechVoicePriority',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRRAudio', 'STSF_AppData',
    ...
    'DISPID_SRRAudioFormat', 'SITooSlow', 'DISPID_SRCEventInterests',
    'DISPID_SVGetAudioInputs', 'DISPID_SVSLastBookmarkId',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRGCmdLoadFromObject',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPIRetainedSizeBytes',
    'ISpeechGrammarRuleStateTransitions', 'SPCT_SUB_COMMAND',
    'SECFEmulateResult', 'DISPID_SpeechPhraseInfo',
    'SAFT8kHz8BitMono', 'DISPID_SGRSTPropertyName',
    'DISPID_SRGIsPronounceable', 'SpeechTokenValueCLSID',
    'DISPID_SRRTLength', 'eLEXTYPE_PRIVATE2', 'SPEI_SR_RETAINEDAUDIO',
    'SpeechGrammarTagDictation', 'SPLEXICONTYPE',
    'DISPID_SLPs_NewEnum', 'SVSFIsNotXML', 'SPXRO_Alternates_SML',
    'SVP_7', 'SPCS_ENABLED', 'SPVOICESTATUS', 'SpVoice',
    '__MIDL_IWinTypes_0009', 'SPEI_RESERVED2', 'DISPID_SRRTTickCount',
    'DISPID_SGRsItem', 'eLEXTYPE_USER_SHORTCUT', 'DISPID_SLWType',
    'SpeechEngineProperties', 'SPPS_RESERVED1',
    'SpeechCategoryAppLexicons', 'eLEXTYPE_APP',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechPhraseProperty',
    'ISpStreamFormatConverter', 'ISpLexicon', '_ISpeechVoiceEvents',
    'SPGS_DISABLED', 'ISpRecoResult', 'DISPID_SGRs_NewEnum',
    'SDTProperty', 'SGRSTTTextBuffer',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SpeechGrammarRule',
    'SpeechPropertyLowConfidenceThreshold', 'eLEXTYPE_PRIVATE19',
    'SAFT22kHz8BitStereo', 'DISPID_SAFGetWaveFormatEx', 'SPAS_STOP',
    'SpeechRuleState', 'SBOPause', 'SP_VISEME_2',
    'SpeechDataKeyLocation', 'DISPID_SPIRule', 'ISpGrammarBuilder',
    'SREPhraseStart', 'DISPID_SpeechLexiconPronunciation',
    'SpeechWordPronounceable', 'DISPID_SRCAudioInInterferenceStatus',
    'SVSFParseSapi', 'SAFTADPCM_8kHzMono', 'DISPID_SWFEExtraData',
    'DISPID_SPRsCount', 'SPSNotOverriden',
    'DISPID_SRCEPropertyNumberChange', 'SPAO_NONE', 'STCRemoteServer',
    'ISpeechRecoResult', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SRProfile', 'DISPID_SpeechAudio', 'SPDKL_CurrentUser',
    'DISPID_SVEViseme', 'SpeechCategoryVoices',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPGS_EXCLUSIVE', 'SPVPRI_NORMAL',
    'SPEI_RESERVED5', 'eLEXTYPE_LETTERTOSOUND', 'ISpeechPhraseRule',
    'DISPID_SpeechLexiconProns', 'DISPID_SRGCmdLoadFromMemory',
    'SAFTCCITT_uLaw_44kHzMono', 'SPSNoun',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SOTGetStorageFileName', '_SPAUDIOSTATE', 'SGRSTTWildcard',
    'DISPID_SAVolume', 'SVP_3', 'DISPID_SOTCategory',
    'ISpRecoGrammar', 'DISPID_SVSLastStreamNumberQueued',
    'eLEXTYPE_PRIVATE6', 'SPFM_OPEN_READONLY',
    'DISPID_SpeechGrammarRuleStateTransition',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPIEnginePrivateData', 'SITooFast', 'ISpNotifySource',
    'DISPID_SRCRequestedUIType', 'SPSHT_Unknown',
    'DISPID_SPPConfidence', 'DISPID_SRCBookmark',
    ...
    'SpShortcut', 'DISPID_SLPType', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRRecognizer', 'SSSPTRelativeToStart', 'SpeechVisemeType',
    'DISPID_SDKDeleteKey', 'SGDisplay', 'SAFT48kHz8BitStereo',
    'SPEI_PHONEME', 'ISpEventSink', 'DISPID_SpeechMemoryStream',
    'SASPause', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPEDisplayText', 'SAFT44kHz8BitMono', 'SPWORD',
    'DISPID_SMSSetData', 'SDKLDefaultLocation', 'DISPID_SDKOpenKey',
    'eWORDTYPE_ADDED', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SVSpeak', 'SPPS_Noun', 'SVPOver', 'SPPROPERTYINFO',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRCPause', 'SpResourceManager',
    'DISPID_SVVoice', 'SSFMOpenForRead', 'DISPID_SPPsItem',
    'SAFT22kHz8BitMono', 'DISPID_SGRSTText', 'SRATopLevel',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpeechPhraseInfoBuilder',
    'SVEPhoneme', 'SREStateChange',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPEI_INTERFERENCE',
    'SpeechAudioFormatType', 'DISPID_SpeechObjectTokens',
    'SPWT_LEXICAL', 'SINoSignal', 'SPTEXTSELECTIONINFO',
    'SRTSMLTimeout', 'SGRSTTWord', 'SPPHRASERULE',
    'SAFTADPCM_11kHzStereo', 'ISpeechGrammarRuleStateTransition',
    'IEnumString', 'STSF_CommonAppData', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpeechRegistryUserRoot', 'ISpeechCustomStream', 'DISPID_SVSkip',
    'SPVPRIORITY', 'SDA_Consume_Leading_Spaces',
    'SAFT24kHz8BitStereo', 'DISPID_SMSGetData', 'eLEXTYPE_PRIVATE3',
    'SPSHT_NotOverriden', 'DISPID_SVSInputSentenceLength',
    'SVEAllEvents', 'STCAll', 'DISPID_SpeechVoice',
    'DISPID_SLWPronunciations', 'DISPID_SAFType',
    'SpeechRecoProfileProperties', 'SPFM_NUM_MODES', 'SAFTText',
    'DISPID_SOTIsUISupported', 'SPGRAMMARSTATE',
    'DISPID_SRCEStartStream', 'SAFTADPCM_44kHzStereo',
    'SpeechPartOfSpeech', 'DISPID_SVSpeakStream',
    'DISPID_SRGDictationSetState', 'DISPID_SLRemovePronunciation',
    'DISPID_SpeechPhraseAlternates', 'SRSEDone', 'eLEXTYPE_RESERVED6',
    'DISPID_SASNonBlockingIO', 'DISPID_SRSClsidEngine',
    'eLEXTYPE_RESERVED8', 'DISPID_SOTRemove', 'DISPID_SAStatus',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPPId',
    'DISPID_SRRPhraseInfo', 'SPCT_SUB_DICTATION',
    'SREFalseRecognition', 'ISpeechPhraseAlternate',
    'SECNormalConfidence', 'DISPID_SVDisplayUI',
    'DISPID_SpeechAudioFormat', 'SAFT11kHz16BitStereo', 'SVEBookmark',
    'DISPID_SPIProperties',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SOTGetDescription', 'SLTApp', 'SpLexicon',
    'DISPID_SLGenerationId', 'SRSEIsSpeaking', 'ISpRecognizer2',
    'SINone', 'SpeechTokenContext', 'DISPID_SRState',
    'DISPID_SRGState', 'SAFTGSM610_44kHzMono', 'SPDKL_CurrentConfig',
    'SVSFlagsAsync', 'DISPID_SRGetFormat', 'SPFM_OPEN_READWRITE',
    'DISPID_SRSCurrentStreamPosition', 'ISpeechPhraseInfo',
    'SpeechGrammarState', 'DISPID_SRSetPropertyString',
    'SP_VISEME_20', 'DISPID_SABIMinNotification',
    'eLEXTYPE_PRIVATE17', 'SAFTADPCM_8kHzStereo', 'DISPID_SGRSRule',
    'SDKLLocalMachine', 'SPAS_PAUSE', 'SpeechRecoEvents',
    'DISPID_SPIElements', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SPRNumberOfElements', 'SVF_Emphasis', 'SRERequestUI',
    'SAFTCCITT_ALaw_8kHzMono', 'SAFTCCITT_ALaw_8kHzStereo',
    'SpeechRecoContextState', 'SVP_19', 'SPSERIALIZEDRESULT',
    'tagSTATSTG', 'SWPKnownWordPronounceable', 'SpeechMicTraining',
    'SP_VISEME_21', 'SPRECOCONTEXTSTATUS', 'SSTTTextBuffer',
    'eLEXTYPE_PRIVATE15', 'DISPID_SLPsItem', 'SP_VISEME_6',
    'SRERecoOtherContext', 'SP_VISEME_12',
    'DISPID_SRSNumberOfActiveRules', 'SPINTERFERENCE_TOOSLOW',
    'SAFTGSM610_8kHzMono', 'SPEI_TTS_BOOKMARK', 'SpeechInterference',
    'SPEI_VISEME', 'ISpObjectTokenCategory', 'SRESoundEnd',
    'SPRST_ACTIVE', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SLWsItem', 'DISPID_SPAsItem', 'SpeechUserTraining',
    'DISPID_SVEEnginePrivate', 'DISPID_SGRClear', 'SGSEnabled',
    'SPXMLRESULTOPTIONS', 'ISpeechObjectTokens',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPCIdToPhone',
    'ISpeechObjectToken', 'SPSMF_UPS',
    'DISPID_SPIAudioStreamPosition', 'ISpeechAudio', 'IStream',
    'SpeechTokenIdUserLexicon', 'ISpeechRecoGrammar',
    'ISpeechPhraseReplacement', 'SpeechTokenKeyAttributes',
    'DISPID_SAFGuid', 'SpeechWordType', 'SPWAVEFORMATTYPE',
    'SPEI_MIN_TTS', 'DISPID_SPARecoResult', 'DISPID_SGRId',
    'DISPID_SDKSetBinaryValue', 'SREBookmark', 'SGSExclusive',
    'SRSActive', 'SPEI_VOICE_CHANGE', 'DISPID_SABIEventBias',
    'DISPID_SPACommit', 'SVSFParseSsml', 'SAFT48kHz16BitMono',
    'DISPID_SPEActualConfidence', 'SDA_One_Trailing_Space',
    'DISPID_SVIsUISupported', 'ISpShortcut', 'SPRST_INACTIVE',
    'DISPID_SVSInputWordLength', 'STCInprocHandler', 'SpeechRunState',
    'SpStreamFormatConverter', 'DISPID_SRAudioInput',
    'ISpeechAudioFormat', 'SPFM_CREATE', 'DISPID_SPRuleConfidence',
    'SpeechPropertyResponseSpeed', 'SVSFParseAutodetect',
    'SRCS_Enabled', 'DISPID_SBSWrite', 'SPPHRASEREPLACEMENT',
    'ISpStreamFormat', 'SPSHORTCUTPAIRLIST', 'SVSFParseMask',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRAudioInputStream',
    'SECFIgnoreWidth', 'SVP_18', 'SP_VISEME_1', 'eLEXTYPE_PRIVATE20',
    'SAFTCCITT_ALaw_11kHzStereo', 'SBONone', 'DISPID_SVEStreamEnd',
    'DISPID_SOTSetId', 'DISPID_SOTRemoveStorageFileName',
    'SPEI_END_INPUT_STREAM', 'SAFT8kHz8BitStereo', 'SPRST_NUM_STATES',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SDKCreateKey',
    'DISPID_SRCResume', 'SAFTCCITT_uLaw_11kHzStereo',
    'SECLowConfidence', 'DISPID_SVPause',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SpeechRecoContextEvents',
    'SITooQuiet', 'STSF_LocalAppData', 'DISPID_SPIAudioSizeTime',
    'SPSUnknown', 'SVEWordBoundary', 'ISpeechGrammarRules',
    'SpPhraseInfoBuilder', 'ISpeechPhraseAlternates',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPAUDIOBUFFERINFO',
    'ISpRecoCategory', 'DISPID_SPEEngineConfidence',
    'SPSInterjection', 'SPEI_RECOGNITION', 'SPPS_RESERVED4',
    'SDKLCurrentUser', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SAEventHandle', 'ISpeechPhraseProperties',
    'tagSPPROPERTYINFO', 'SPEVENT', 'DISPID_SVSPhonemeId',
    'SPEI_RECO_STATE_CHANGE', 'SSFMOpenReadWrite',
    'DISPID_SPIStartTime', 'SRAExport', 'Speech_StreamPos_Asap',
    'SAFT48kHz16BitStereo', 'DISPID_SVSInputWordPosition',
    'DISPID_SRCSetAdaptationData', 'DISPID_SGRAddState',
    'SREStreamEnd', 'DISPID_SMSALineId', 'SPEI_END_SR_STREAM',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechVoiceSpeakFlags', 'SPPHRASEELEMENT', 'DISPID_SPPName',
    'SDTPronunciation', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SPAs_NewEnum', 'SGLexicalNoSpecialChars',
    'DISPID_SRRSaveToMemory', 'SpeechStreamFileMode', 'SRAImport',
    'SDKLCurrentConfig', 'ISpeechRecoContext', 'SPBO_PAUSE',
    'SpeechTokenShellFolder', 'SpMMAudioEnum', 'DISPID_SOTCSetId',
    'SPRECOGNIZERSTATUS', 'ISpRecoGrammar2', 'SDTLexicalForm',
    'SP_VISEME_14', 'SP_VISEME_17', 'DISPID_SLGetPronunciations',
    'ISpeechTextSelectionInformation', 'SpeechAudioProperties',
    'Speech_Default_Weight', 'DISPID_SPCLangId', 'SRSActiveAlways',
    'SAFT44kHz8BitStereo', 'DISPID_SpeechMMSysAudio', 'SP_VISEME_18',
    'SpPhoneticAlphabetConverter', 'SASStop', 'SpeechVoiceEvents',
    'DISPID_SpeechLexiconWord', 'SVSFIsXML', 'SPSLMA', 'SVF_None',
    'ISpNotifyTranslator', 'SPPARTOFSPEECH', 'eLEXTYPE_PRIVATE10',
    'SAFT32kHz16BitMono', 'SAFTGSM610_22kHzMono', 'SRSInactive',
    'DISPID_SpeechLexiconWords', 'SPADAPTATIONRELEVANCE',
    'SPEI_TTS_PRIVATE', 'SPSHT_EMAIL',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SRGId',
    'SVEEndInputStream', 'SECFIgnoreKanaType', 'DISPID_SGRSTRule',
    'eLEXTYPE_PRIVATE14', 'DISPID_SPRuleName', 'DISPID_SGRAttributes',
    '_RemotableHandle', 'SRCS_Disabled', 'SpeechGrammarWordType',
    ...
    'ISpeechRecognizer', 'SPRS_ACTIVE', 'eLEXTYPE_RESERVED7',
    'SPFM_CREATE_ALWAYS', 'ISpRecoContext2', 'DISPIDSPTSI',
    'ISpPhraseAlt', 'ISpPhoneConverter', 'eLEXTYPE_RESERVED10',
    'DISPID_SPIGetText', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRCEAdaptation', 'SpeechVoiceCategoryTTSRate',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechRecognitionType',
    'ISpeechPhraseRules', 'SPSEMANTICFORMAT', 'SVP_1',
    'DISPID_SPRules_NewEnum', 'SVSFNLPMask', 'DISPID_SLPPhoneIds',
    'SPEI_TTS_AUDIO_LEVEL', 'SPRECORESULTTIMES', 'SpFileStream',
    'DISPID_SGRSTransitions', 'DISPID_SOTCId', 'DISPID_SRRSpeakAudio',
    'Speech_StreamPos_RealTime', 'SECHighConfidence',
    'DISPID_SpeechAudioStatus', 'SAFT32kHz8BitMono',
    'SPINTERFERENCE_NOISE', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SOTGetAttribute',
    'DISPID_SABufferInfo', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SFSClose',
    'STSF_FlagCreate', 'ISpeechLexiconPronunciation',
    'SpeechLexiconType', 'SAFT11kHz8BitStereo',
    ...
    'SpeechAllElements', 'SPSModifier', 'SVP_11',
    'ISpeechPhraseProperty', 'SPAUDIOOPTIONS',
    'SpeechCategoryAudioIn', 'SRTAutopause', 'ISpDataKey',
    'DISPID_SVStatus', 'SpSharedRecoContext', 'SVF_Stressed',
    'DISPID_SGRsFindRule', 'SGDSActiveUserDelimited', 'SVSFVoiceMask',
    'SpMMAudioIn', 'STCLocalServer', 'ISpPhrase',
    'DISPID_SRCRetainedAudioFormat', 'SVP_13',
    'DISPID_SpeechPhraseRules', 'SpeechStreamSeekPositionType',
    'IInternetSecurityMgrSite', 'DISPID_SpeechPhraseElements',
    'DISPID_SPPChildren', 'SPEI_RESERVED1', 'SpStream',
    'DISPID_SPRsItem', 'DISPID_SGRSTWeight', 'SSTTWildcard',
    'DISPID_SVSLastBookmark', 'DISPID_SASFreeBufferSpace', 'SPPS_LMA',
    'eLEXTYPE_PRIVATE18', 'SRSInactiveWithPurge', 'SpeechFormatType',
    'SAFTNonStandardFormat', 'DISPID_SpeechPhraseRule',
    'DISPID_SRCEEnginePrivate', 'SGSDisabled', 'SPVISEMES',
    'ISpeechGrammarRule', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SpeechRecoResult', 'DISPID_SBSRead', 'DISPID_SRCVoice',
    'SPBO_TIME_UNITS', 'SPEI_SR_PRIVATE',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SLAddPronunciation',
    'SPAS_RUN', 'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPCONTEXTSTATE',
    'ISpeechResourceLoader', 'SSTTDictation', 'SVP_10',
    'SPRS_INACTIVE', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpeechDictationTopicSpelling', 'DISPID_SpeechPhraseElement',
    'DISPID_SGRSTNextState', 'ISpeechLexiconPronunciations',
    'DISPID_SVAudioOutputStream', 'SPEI_START_SR_STREAM',
    'SRADefaultToActive', 'SP_VISEME_5', 'SAFTADPCM_22kHzMono',
    'DISPID_SPRuleFirstElement', 'SPEI_SENTENCE_BOUNDARY',
    'SPEI_REQUEST_UI', 'DISPID_SLGetGenerationChange',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRCVoicePurgeEvent',
    'SPEVENTSOURCEINFO', 'IInternetSecurityManager', 'SPSHT_OTHER',
    'DISPID_SVSLastResult', 'ISpeechMMSysAudio', 'SPAUDIOSTATE',
    'DISPID_SADefaultFormat', 'DISPID_SOTCEnumerateTokens',
    'eLEXTYPE_PRIVATE1', 'SREHypothesis', 'ISpXMLRecoResult',
    'SVP_20', 'eLEXTYPE_RESERVED4', 'SRTStandard',
    'DISPID_SGRSTsItem', 'SREPropertyStringChange',
    'DISPID_SWFESamplesPerSec', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRGetRecognizers', 'SPVPRI_OVER', 'SPAR_Low',
    'ISpMMSysAudio', 'SAFTCCITT_uLaw_8kHzMono',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SGRSTTRule', 'UINT_PTR',
    'DISPID_SVVolume', 'SpInprocRecognizer',
    'SpeechCategoryRecoProfiles', 'SVP_16', 'SpeechRuleAttributes',
    'ISpeechPhraseReplacements', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'ISpeechXMLRecoResult',
    'DISPID_SPIGrammarId', 'ISpeechGrammarRuleState',
    'DISPID_SPEPronunciation', 'DISPID_SVEBookmark',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SASRun',
    'DISPID_SFSOpen', 'SPEI_MAX_SR', 'SVP_17', 'SDTDisplayText',
    'DISPID_SDKGetlongValue', 'SPRULE',
    'DISPID_SRGSetWordSequenceData', 'SP_VISEME_9',
    'SSFMCreateForWrite', 'DISPID_SRCCreateResultFromMemory',
    'SVP_15', 'SPSFunction', 'DISPID_SDKDeleteValue', 'SpObjectToken',
    'DISPID_SRGRecoContext', 'SAFTTrueSpeech_8kHz1BitMono',
    'SRTExtendableParse', 'DISPID_SRCEBookmark',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPCT_SLEEP', 'DISPID_SLPsCount',
    'ISpeechPhoneConverter', 'DISPID_SPEAudioSizeTime',
    'DISPID_SAFSetWaveFormatEx', 'SVP_12', 'DISPID_SPRs_NewEnum',
    'SpeechVisemeFeature', 'SpNullPhoneConverter', 'SFTInput',
    'DISPID_SPCPhoneToId', 'eLEXTYPE_PRIVATE9', 'SVEPrivate',
    'SAFT22kHz16BitStereo', 'SPWORDTYPE', 'DISPID_SVEventInterests',
    'DISPID_SRCESoundStart', 'DISPID_SLWsCount', 'SPGRAMMARWORDTYPE',
    'SGRSTTDictation', 'SGDSActive', 'SPPS_RESERVED2', 'SPAS_CLOSED',
    'DISPID_SPAsCount', 'SPEI_PHRASE_START', 'SpSharedRecognizer',
    'DISPID_SLPSymbolic', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SVWaitUntilDone',
    'DISPID_SpeechDataKey', 'SPSHORTCUTPAIR', 'DISPID_SPEsCount',
    'DISPID_SPRulesCount', 'SPPS_Modifier', 'ISpeechRecoResult2',
    'DISPID_SRCESoundEnd', 'SLOStatic', 'SDA_Two_Trailing_Spaces',
    'DISPID_SpeechObjectToken', 'SWTDeleted', 'SP_VISEME_13',
    'SECFNoSpecialChars', 'SVEAudioLevel', 'SPPHRASEPROPERTY',
    'DISPID_SpeechFileStream', 'SPSEMANTICERRORINFO',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRGCmdSetRuleIdState',
    'SPSVerb', 'ISpeechMemoryStream', 'SSSPTRelativeToEnd',
    'SpeechCategoryPhoneConverters', 'SRAONone',
    'IEnumSpObjectTokens', 'SPAR_Unknown', 'SP_VISEME_3', 'SVEViseme',
    'SPPS_Noncontent', 'SPDKL_DefaultLocation', 'ISpeechFileStream',
    'SGDSActiveWithAutoPause', 'SLTUser', 'DISPID_SLGetWords',
    'WAVEFORMATEX', 'DISPID_SpeechVoiceEvent',
    'DISPID_SPIReplacements', 'DISPID_SPRFirstElement',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SGRAddResource',
    'SVSFDefault', 'DISPID_SWFEBitsPerSample', 'ISpeechBaseStream',
    'SPEI_WORD_BOUNDARY', 'SVP_5', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SpeechCategoryRecognizers', 'DISPID_SMSAMMHandle',
    'DISPID_SVPriority', 'SpeechAddRemoveWord',
    'SVSFPurgeBeforeSpeak', 'SVP_0', 'LONG_PTR',
    'DISPID_SRCEEndStream', 'SPEVENTENUM', 'DISPID_SRStatus',
    'SpObjectTokenCategory', 'SPAR_Medium', 'SPLO_DYNAMIC',
    'SSFMCreate', 'DISPID_SVEAudioLevel', 'SAFT12kHz8BitMono',
    'SAFT44kHz16BitStereo', 'SVP_8', 'DISPID_SPRuleId',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SPERequiredConfidence',
    'DISPID_SRGDictationUnload', 'Speech_Max_Word_Length',
    'DISPID_SABufferNotifySize', 'SRADynamic', 'DISPID_SVEWord',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPPEngineConfidence',
    'ISpResourceManager', 'ISpeechAudioBufferInfo',
    'ISpPhoneticAlphabetSelection', 'SPINTERFERENCE_LATENCY_WARNING',
    'SPEI_RESERVED3', 'DISPID_SRCEHypothesis', 'ISpeechAudioStatus',
    'ISpeechDataKey', 'DISPID_SRRSetTextFeedback', 'SREAllEvents',
    'DISPID_SpeechRecognizer', 'DISPID_SpeechPhraseBuilder',
    'SAFT24kHz16BitStereo', 'DISPID_SPPsCount',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPANumberOfElementsInResult',
    'SGRSTTEpsilon', 'DISPID_SOTMatchesAttributes', 'ISpObjectToken',
    'SDTRule', 'DISPID_SRRTStreamTime', 'SP_VISEME_0',
    'SAFT12kHz8BitStereo', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SPRulesItem', 'SpUnCompressedLexicon', 'SVEVoiceChange',
    'DISPID_SREmulateRecognition', 'SGDSInactive',
    'SpeechPropertyComplexResponseSpeed', 'SPWORDPRONOUNCEABLE',
    'DISPID_SASetState', 'DISPID_SRRGetXMLResult', 'ISpProperties',
    'SpeechPropertyHighConfidenceThreshold', 'SPBINARYGRAMMAR',
    'SPDATAKEYLOCATION', 'SPSHORTCUTTYPE', 'SPCS_DISABLED',
    'DISPID_SRCState', 'DISPID_SPISaveToMemory',
    ...
    'DISPID_SDKSetLongValue', 'SP_VISEME_7',
    'DISPID_SpeechPhraseAlternate', 'SVSFNLPSpeakPunc',
    'DISPID_SpeechWaveFormatEx', 'SREPrivate',
    'DISPID_SRCCmdMaxAlternates',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpeechEmulationCompareFlags', 'SASClosed', 'SAFT8kHz16BitMono',
    'ISpAudio', 'Speech_Max_Pron_Length', 'SPEI_ADAPTATION',
    'SPEI_MIN_SR', 'DISPID_SRGReset', 'SP_VISEME_8', 'SVP_4',
    'SVP_14', 'SPWORDLIST', 'DISPID_SRRGetXMLErrorInfo',
    ...
    'ISpeechRecognizerStatus', 'SREAdaptation', 'DISPID_SBSSeek',
    'SPWT_DISPLAY', 'DISPID_SPPValue',
    'DISPID_SGRSAddSpecialTransition', 'SP_VISEME_19',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRCEPhraseStart',
    'DISPID_SVSCurrentStreamNumber', 'SPINTERFERENCE_NOSIGNAL',
    'SPSTREAMFORMATTYPE', 'SpeechBookmarkOptions', 'DISPID_SPRText',
    'ISpeechLexiconWord', 'SpMemoryStream', 'SECFIgnoreCase',
    'DISPID_SDKSetStringValue', 'SGPronounciation',
    'DISPID_SRDisplayUI', 'eLEXTYPE_RESERVED9', 'SpeechAudioState',
    'DISPID_SGRName', 'SDTAll', 'DISPID_SpeechCustomStream',
    'DISPID_SVSInputSentencePosition', 'SAFT12kHz16BitMono',
    'DISPID_SGRsCommit', 'eLEXTYPE_PRIVATE13',
